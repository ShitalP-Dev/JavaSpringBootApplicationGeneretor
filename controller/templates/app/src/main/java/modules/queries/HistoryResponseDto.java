...
@AllArgsConstructor
@ToString
public class <%= entityName %>HistoryResponseDto extends BaseDto{
   ...
   <%_ for(const field of fields) { _%>
    ...
    <%_ }else{ _%>
    <%_ if (relationship.relationshipType === "one-to-many") { _%>
    private List<<%= relationship.otherEntityName %>QueryResponseDto> <%= relationship.relationshipName %> ;
    <%_ } _%>
    <%_ if (relationship.relationshipType === "many-to-one") { _%>
      private <%= relationship.otherEntityName %>QueryResponseDto <%= relationship.relationshipName %> ;
    <%_ } _%>
    <%_ if (relationship.relationshipType === "many-to-many") { _%>
      private List<<%= relationship.otherEntityName %>QueryResponseDto> <%= relationship.relationshipName %>;
    <%_ } _%>
