...
<%_ } _%>
    ...
    <%_ } _%>
    <%_ } _%>
    private List<<%= relationship.otherEntityName %>CommandRequestDto> <%= relationship.relationshipName %> ;
    <%_ } _%>
    <%_ if (relationship.relationshipType === "many-to-one") { _%>
    <%_ if (relationship.validation) { _%>
    <%_ if (relationship.validation.notNull) { _%>
    ...
    <%_ } _%>
    <%_ } _%>
    private <%= relationship.otherEntityName %>CommandRequestDto <%= relationship.relationshipName %> ;
    <%_ } _%>
    <%_ if (relationship.relationshipType === "many-to-many") { _%>
    <%_ if (relationship.validation) { _%>
    <%_ if (relationship.validation.notNull) { _%>
