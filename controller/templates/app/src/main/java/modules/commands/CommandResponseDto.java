...
@AllArgsConstructor
@ToString
public class <%= entityName %>CommandResponseDto extends BaseDto {
...
<%_ } _%>
    ...
    <%_ }else{ _%>
    <%_ if (relationship.relationshipType === "one-to-many") { _%>
      private List<<%= relationship.otherEntityName %>CommandResponseDto> <%= relationship.relationshipName %> ;
    <%_ } _%>
    <%_ if (relationship.relationshipType === "many-to-one") { _%>
      private <%= relationship.otherEntityName %>CommandResponseDto <%= relationship.relationshipName %> ;
    <%_ } _%>
    <%_ if (relationship.relationshipType === "many-to-many") { _%>
      private List<<%= relationship.otherEntityName %>CommandResponseDto> <%= relationship.relationshipName %>;
    <%_ } _%>
