...
*/
    configuring() {
        this.destinationRoot(path.join(this.destinationRoot(), '/'+this.configOptions.appName+'/'+this.configOptions.serviceName));
    ...
    _generateAppCode(configOptions) {
        ...
        const mainJavaTemplates = [
            ...
            'commons/dtos/ResponseDto.java',
            'commons/dtos/BaseDto.java',
            'commons/dtos/BaseRequestDto.java',
            'commons/dtos/BaseEntity.java',
            'commons/exceptions/ApplicationException.java',
            'commons/exceptions/InfrastructureException.java',
            'commons/exceptions/DomainException.java',
            'commons/exceptions/GlobalExceptionHandler.java',
            'commons/utils/Constants.java',
            'commons/utils/Utilities.java'
        ];
        if(configOptions.cloudFeatures.includes("localstack")) {
    ...
    _generateDockerComposeFiles(configOptions) {
        ...
        if(configOptions.cloudFeatures.includes('monitoring')) {
            this._generateMonitoringConfig(configOptions);
        }
        if(configOptions.cloudFeatures.includes('elk')) {
